...
export function apply(_ctx) {
  // Do not read or write any ctx property. cordis throws on undeclared access
  // and a thrown apply() takes down the whole DSH web process.
  try {
    console.log(describe(applyInjection()));
  } catch (err) {
    try {
